...
<title><%=nvl(rDTO.getNotice_title())%></title>
				...
				<ul class="nav">
					...
					<div id="collapseFour" class="collapse">
						<ul class="nav" style="text-align: center">
							...
							<li class="nav-item"><a class="nav-link"
								href="/hospital/hospital.do">선별진료소</a></li>
							<li class="nav-item"><a class="nav-link" href="/inquiry/inquirylist.do">문의내역</a></li>
							<li class="nav-item"><a class="nav-link"
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="row"
									...
									<p class="small mb-1">
										조회수 :
										<%=nvl(rDTO.getNotice_cnt())%>
										&nbsp; | &nbsp; 작성자 :
										<%=nvl(rDTO.getN_nick_name())%>
										&nbsp; | &nbsp; 작성일 :
										<%=nvl(rDTO.getRdate())%>
									</p>
								</div>
								...
								<div class="row" style="justify-content: center;">
									<h2 class="card-title"><%=nvl(rDTO.getNotice_title())%></h2>
								</div>
								<hr />

								<div class="row" style="justify-content: center;">
											<textarea cols="100%" style="resize: none;  height: 350px;" readonly><%=nvl(rDTO.getNotice_content())%></textarea>
								...
								<div class="row"
									...
									&nbsp;&nbsp;&nbsp;
									<button class="btn-dark btn-simple caret" type="button"
										onclick="mvedit()">수정</button>
									&nbsp;&nbsp;&nbsp;
									<button class="btn-dark btn-simple caret" type="button"
										onclick="deleteNt()">삭제</button>
...
<script>
	function mvedit() {
		location.href= "/notice/editnotice.do?no=<%=rDTO.getNotice_no()%>"
	}
</script>
...
<script type="text/javascript">
  function deleteNt(){
				if(confirm("삭제하시겠습니까?")){
					location.href="/notice/NoticeDelete.do?no=<%=rDTO.getNotice_no()%>";
		}
	}
</script>
