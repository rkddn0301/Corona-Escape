				...
				<div class="container-fluid">
					<div class="col-lg-20">
						<div class="card">
							...
							<div class="card-body">
								<form id="notice_regist" method="post" name="f"
								action = "/notice/registsuccess.do">
									<input type="hidden" name="user_no" id="user_reg_no"
										value="<%=SS_USER_NO%>" /> <input type="hidden"
										name="user_id" id="user_reg_id" value="<%=SS_USER_ID%>" /> <input
										type="hidden" name="nick_name" id="user_nick_name"
										value="<%=SS_NICK_NAME%>" /> <input type="hidden"
										name="author" id="user_author" value="<%=SS_AUTHOR%>" />
									<div class="row" style="justify-content: center;">
										<div class="form-group">
											<h5>
												<b>제목</b>
											</h5>
											<input class="form-control py-4" id="notice_reg_title"
									...
									<div class="row" style="justify-content: center;">
										<div class="form-group">
											<textarea class="form-control py-4" id="notice_reg_content"
...
<!-- 등록버튼 -->
<script type="text/javascript" src="/script/RegistNt_suc.js"></script>
