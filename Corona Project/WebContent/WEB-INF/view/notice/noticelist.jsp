						...
						<form name="s" method="post">
								<div class="row">
									...
									<div class="col-sm-12">
										...
										<input type="search" id="searchNotice" name="search"
									...
									<div class="col-sm-12" id="tables">
										...
										<div class="row" id="tablebody">
											...
											<div class="col-sm-5"><a
												href="/notice/noticedetail.do?no=<%=rDTO.getNotice_no()%>"><%=CmmUtil.nvl(rDTO.getNotice_title())%></a></div>
											<div class="col-sm-2"><%=CmmUtil.nvl(rDTO.getN_nick_name())%></div>
											<div class="col-sm-4"><%=CmmUtil.nvl(rDTO.getRdate())%></div>
...
function Previous(no) {
	...
	s.action = "/notice/noticelist.do?no="+no;
	s.submit();
...
<script>
	function mvinsert() {
		location.href = "/notice/noticeregist.do";
	}
</script>
