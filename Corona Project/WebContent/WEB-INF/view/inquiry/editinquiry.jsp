				...
				<div class="container-fluid">
					<div class="col-lg-20">
						<div class="card">
							...
							<div class="card-body">
								<form id="inquiry_update" method="post" name="f"
									action="/inquiry/editIQ.do">
									<input type="hidden" name="no" id="inquiry_no"
										value="<%=nvl(rDTO.getInquiry_no())%>" /> <input
										type="hidden" name="i_user_no" id="user_reg_no"
										value="<%=SS_USER_NO%>" />
									<div class="row" style="justify-content: center;">
										<div class="form-group">
											...
											<input class="form-control py-4" id="inquiry_up_title"
												name="inquiry_title" placeholder="제목 입력"
												style="width: 300px; height: 50px;" autocomplete="off"
												value="<%=nvl(rDTO.getInquiry_title())%>" readonly/>
										</div>
									</div>
									
									<div class="row" style="justify-content: center;">
										<div class="form-group">
											<textarea class="form-control py-4" id="inquiry_user_content"
												name="inquiry_us_content" placeholder="내용 입력" maxlength="2048"
												cols="100%" style="resize: none; height: 350px;" readonly><%=nvl(rDTO.getInquiry_content())%></textarea>
										</div>
									</div>
									...
									<div class="row" style="justify-content: center;">
										<div class="form-group">
											<textarea class="form-control py-4" id="inquiry_up_content"
												name="inquiry_content" placeholder="내용 입력" maxlength="2048"
												cols="100" style="resize: none; height: 350px;"></textarea>
...
<!-- 답변버튼 -->
<script type="text/javascript" src="/script/UpdateIQ_suc.js"></script>
