									...
									<div class="row">
										<div class="form-group" >
											<div id="map_layout">
												...
												<svg id="svg" xmlns:mapsvg="http://mapsvg.com"
													xmlns:dc="http://purl.org/dc/elements/1.1/"
													xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
													xmlns:svg="http://www.w3.org/2000/svg"
													xmlns="http://www.w3.org/2000/svg"
													mapsvg:geoViewBox="125.384480 38.612150 130.921968 33.194037"
													width="32.764835625rem" height="630.5871" preserveAspectRatio="none"
													viewbox="-10 10 550 600"	>
		 											...
		 											<g>		 				 											 											 									
		  											<path
														...
														title="Seoul" id="KR-11" class="land" onclick="getSeoul()" />
		  											<path
		 											 ...
		 											 <path
														...
														title="Incheon" id="KR-28" class="land"
														onclick="getIncheon()" />
		 											 <path
														...
														title="Gwangju" id="KR-29" class="land"
														onclick="getGwangju()" />
		 											 <path
														...
														title="Daejeon" id="KR-30" class="land"
														onclick="getDaejeon()" />
		  											<path
		  											...
		  											<path
														...
														title="Sejong" id="KR-50" class="land"
														onclick="getSejong()" />
													
													<a href="#" onclick="getSeoul()"><text x="141.25429" y="137.63884" font-size="12">서울</text></a>
													<a href="#" onclick="getBusan()"><text x="342.20429" y="402.50884" font-size="12">부산</text></a>
													<a href="#" onclick="getDaegu()"><text x="288.06429" y="341.13884" font-size="12">대구</text></a>
													<a href="#" onclick="getIncheon()"><text x="103.77429" y="144.42884" font-size="12">인천</text></a>
													<a href="#" onclick="getGwangju()"><text x="129.37429" y="414.96884" font-size="12">광주</text></a>
													<a href="#" onclick="getDaejeon()"><text x="182.76429" y="281.00884" font-size="12">대전</text></a>
													<a href="#" onclick="getUlsan()"><text x="351.40429" y="376.70884" font-size="12">울산</text></a>
													<a href="#" onclick="getGyeonggi()"><text x="159.574286" y="102.98884">경기</text></a>
													<a href="#" onclick="getGangwon()"><text x="251.58429" y="102.358837">강원</text></a>
													<a href="#" onclick="getNtChungcheong()"><text x="214.60429" y="216.87884">충북</text></a>
													<a href="#" onclick="getStChungcheong()"><text x="112.784286" y="260.55884">충남</text></a>
													<a href="#" onclick="getNtJeolla()"><text x="149.12429" y="347.63884">전북</text></a>
													<a href="#" onclick="getStJeolla()"><text x="137.004286" y="436.88884">전남</text></a>
													<a href="#" onclick="getNtGyeongsang()"><text x="291.63429" y="281.21884">경북</text></a>
													<a href="#" onclick="getStGyeongsang()"><text x="251.63429" y="396.21884">경남</text></a>
													<a href="#" onclick="getJeju()"><text x="95.84429" y="612.92884">제주</text></a>
													<a href="#" onclick="getSejong()"><text x="161.53429" y="252.61884" font-size="12">세종</text></a>
													</g>
												</svg>
											</div>
										</div>
										...
										<div class="form-group" style="width: 60%;">
											<div class="col-lg-12">
												...
												<div class="card-body" style="text-align:center; width:50%; height:190px; border : 1px solid grey;">
													<p id="countryName"></p>
													<p id="countrycase"></p>
													<p id="recovered"></p>
													<p id="death"></p>
...
<!-- 지역 확진자 수 -->
<script type="text/javascript" src="/script/Country_suc.js"></script>
